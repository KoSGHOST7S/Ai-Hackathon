...
## Set extensions for student quiz submissionsQuizzes::QuizExtensionsController#create
...
| quiz_extensions[][manually_unlocked] |  | boolean | Allow the student to take the quiz even if itâs locked for everyone else. |
...
| quiz_extensions[][extend_from_end_at] |  | integer | The number of minutes to extend the quiz beyond the quizâs current ending time. This is mutually exclusive to extend_from_now. This is limited to 1440 minutes (24 hours) |
