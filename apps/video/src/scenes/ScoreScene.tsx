...
const ScoreContent: React.FC<{ frame: number; fps: number }> = ({
  frame,
  fps,
}) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span style={{ fontSize: 12, fontWeight: 500, color: EXT.fg }}>
          AI Review
        </span>
      </div>
      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "baseline", gap: 4 }}>
            ...
            <span style={{ fontSize: 20, color: EXT.mutedFg, fontWeight: 500 }}>
              /{MAX}
            </span>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
            ...
            <span style={{ fontSize: 12, color: EXT.mutedFg }}>
              {Math.round(
                interpolate(pctP, [0, 1], [0, Math.round((TOTAL / MAX) * 100)])
              )}
              % — Strong pass
            </span>
          </div>
            ...
            {SCORES.map((s, i) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <span
                      style={{ fontSize: 11, fontWeight: 500, color: EXT.fg }}
                    >
                      {s.name}
                    </span>
                    <span
        ...
        <div
          style={{
            ...
            border: "1px solid rgba(76,168,122,0.2)",
            borderRadius: 10,
            padding: 12,
          }}
        >
          ...
          <p style={{ fontSize: 11, color: EXT.fg, margin: 0, lineHeight: 1.4 }}>
            Citations could be more consistent. Switch to one citation style and
            ensure all in-text citations match your bibliography.
          </p>
        </div>
      </div>
...
export const ScoreScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill>
      <Background glowX={960} glowY={500} />
      <ExtensionShell
        scale={1.22}
        opacity={interpolate(entryP, [0, 1], [0, 1])}
      >
        <ScoreContent frame={frame} fps={fps} />
      </ExtensionShell>
      <SceneCaption title="Know your grade before you submit" delay={15} />
    </AbsoluteFill>
  );
};
